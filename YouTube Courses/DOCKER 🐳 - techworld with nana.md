...
- Kernel interact between hardware and software components
### What parts of the OS do they virtualize
| Terms       | Docker                                                                                                                                                         | VM                                                      |
| ----------- | -------------------------------------------------------------------------------------------------------------------------------------------------------------- | ------------------------------------------------------- |
| Explanation | - Contains the OS application layer<br>- Service and apps installed on top of application layer<br>- OS kernel is host, because it doesn't have its own kernel | - It have both OS application layer and OS kernel layer |
| Size        | Docker images, couple of MB                                                                                                                                    | VM images, couple of GB                                 |
| Speed       | Containers take seconds to start                                                                                                                               | VMs take minutes to start                               |
| Compability | Compability with linux distros                                                                                                                                 | VM is compatible with all OS                            |
![](https://k21academy.com/wp-content/uploads/2020/05/2020_05_13_12_19_07_PowerPoint_Slide_Show_Azure_AZ104_M01_Compute_ed1_.png)
>[!warning]
>Linux based Docker images, cannot use window kernel
>Most containers are linux based. Originally built for linux
### Docker Desktop
- [p] Allows you to run linux containers on windows and mac OS
- [p] User a hypervisor layer with a lightweight linux distro.
## Install Docker
...
### Docker engine
- A server with log-running deamon process "dockerd"
- Manages images and containers
### Docker CLI-Client
- Command line interface "docker" to interact with docker server.
- Execute docker command to start/stop containers.
### GUI Client
To manage your container and images with a GUI.
